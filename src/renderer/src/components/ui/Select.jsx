...
const Select = (props) => {
    ...
    return (<div class={`relative w-full ${isOpen() ? 'z-20' : 'z-10'}`}>
      <div class="cursor-pointer rounded-lg border-solid border-dark px-4 py-[2px] text-center hover:border-active" ref={(el) => {
            const fn = (e) => {
        ...
        <div class="absolute z-20 mt-1 w-full rounded-lg bg-dark-plus p-1 shadow-center">
          <div class="scrollbar-show max-h-40">
            <For each={props.options}>
              {(option) => (<div class="my-2 cursor-pointer text-center" onClick={() => handleSelect(option)}>
