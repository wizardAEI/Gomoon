...
export default function (props: { type: 'chat' | 'ans'; botName: string }) {
  ...
  return (
    <div class="group/capsule fixed left-1/2 top-10 z-20 flex -translate-x-1/2 select-none items-center rounded-xl bg-dark-pro">
      ...
      <div class="h-[27px] w-[2px] bg-dark-plus group-hover/capsule:bg-active"> </div>
      <div class="relative rounded-xl rounded-l-none border-2 border-l-0 border-solid border-dark-plus px-[6px] py-1 hover:border-active">
