...
export default function Capsule(props) {
    ...
    return (<div class="group/capsule fixed left-1/2 top-10 z-20 flex -translate-x-1/2 select-none items-center rounded-xl border-2 border-solid border-dark-con bg-dark-pro duration-200">
      <div onClick={() => {
      ...
      <Show when={pageData.isSpeech}>
        <div class="group/playing absolute -right-8 flex cursor-pointer items-center rounded-full bg-dark-pro">
          ...
          <CrossMarkRound width={22} height={22} onClick={() => {
