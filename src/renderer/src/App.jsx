...
const App = (props) => {
    ...
    onMount(async () => {
        ...
        const removeListener = window.api.multiCopy(async (_, msg) => {
            nav('/ans?q=' + msg);
        });
        ...
        createEffect(() => {
            ...
            document.documentElement.style.setProperty('--font-family', f === 'default' ? 'var(--font-family-default)' : f);
        });
        // FEAT: receive msg
        window.api.receiveMsg(async (_, msg) => {
