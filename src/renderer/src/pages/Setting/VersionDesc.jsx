...
export default function () {
    ...
    return (<>
      <div class="mt-2 flex items-center gap-2 text-text2">
        ...
        <a class="cursor-pointer text-text-link hover:text-active" onClick={async () => {
            loading.show('正在检查更新');
            try {
      ...
      <div class="mt-1 text-text2">
        ...
        <Show when={showMore()} fallback={<a class="mt-3 cursor-pointer text-text-link hover:text-active" onClick={async () => setShowMore(true)}>
              查看更多
            </a>}>
