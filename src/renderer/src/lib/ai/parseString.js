...
export function parseString(str, isLastMsg = false) {
...
export function extractMeta(str, isLastMsg = false) {
    resetReg();
    const arr = [];
    const { regForFile, regForUrl, regForSearch, regForMemo, regForQuestion, regForVal, regForDrawer, regForImage } = regDict;
...
export function parseDisplayArr(str) {
    resetReg();
